...
export const techItems = [
  ...
  { name: "Git", description: "Version Control", src: "/icons/git.svg", className: "brightness-110 contrast-125 scale-110", bgColor: "bg-orange-500/10", borderColor: "hover:border-orange-400/50", shadowColor: "group-hover:shadow-orange-400/10" },
  { name: "PostgreSQL", description: "Database", src: "/icons/postgres.png", className: "brightness-110 contrast-125 scale-110", bgColor: "bg-[#336791]/20", borderColor: "hover:border-[#336791]/60", shadowColor: "group-hover:shadow-[#336791]/20" },
   { name: "xUnit", description: "Testing", src: "/icons/xunit.png", bgColor: "bg-white/10", borderColor: "hover:border-white/50", className: "invert brightness-200", shadowColor: "group-hover:shadow-white/10" },
