        ...
        <div className="container mx-auto max-w-7xl px-4">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="relative group">
              ...
              <Image
                src="/portfolio-imgs/FallBotLaptop.png"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <motion.div variants={itemVariants}>
                ...
                <div className="flex mt-8 gap-4">
                  {/* BBUTTON */}
                  <Link href="CommingSoonBot" className="bg-white text-black py-4 px-8 rounded-xl flex items-center gap-3 font-bold hover:bg-[#1771BF] hover:text-white transition-all shadow-xl shadow-black/20">
                    Code <FontAwesomeIcon icon={faCode} className="h-5 w-5" />
                  </Link>
                  {/* BBUTTON */}
                  <Link href="CommingSoonBot" className="border border-white/10 text-white py-4 px-8 rounded-xl flex items-center gap-3 font-bold hover:bg-white/5 transition-all">
